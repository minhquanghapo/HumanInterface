                    ...
                    <div class="col-sm-5">
                     ...
                     <div class="col-sm-3">
                        <div class="input-group">
                            <span class="input-group-addon" title="Level">User role</span>
                            <select class="form-control">
                                <option value="TU">Admin Hospital</option>
                                <option value="TP">Doctor</option>
                                <option value="HUYEN">Patient</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <form action="/search" method="POST" role="search">
                            {{ csrf_field() }}
                            <div class="input-group">
                                <input type="text" class="form-control" name="q" placeholder="Search Hospital..."> 
