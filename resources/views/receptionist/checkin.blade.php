...
@section('customcss')
    ...
    <link rel="stylesheet" href="/css/receptionist/style.css">
    <style >
        .row{
            font-size: medium;
        }
    ...
    <style> video { width:265px; height:200px; border:1px solid blue; } </style>
    {{--<style> #check_su_dung_bhyt { width:50px; height:50px; border:1px solid blue; } </style>--}}
@endsectio  n
@section('pagename')
    <div clas="row">

        <div class="col-md-6"> <div id="checkin_form">
                <form id="signup" action="somewhere" method="POST">
                    <ul id="checkin-tabs">
                        <li class="current active"><span>1.</span> Đã có hồ sơ khám</li>
                        <li><span>2.</span> Nhập mới hồ sơ</li>
                    </ul>
                    <div id="fieldsets">

                        <fieldset class="current">
                            {{--<label for="email">Có sử dụng bảo hiểm y tế</label>--}}
                            {{--<input name="email" type="email" class="required email" />--}}



                            {{--<input type="checkbox" id="check_su_dung_bhyt" value="Boat"checked="unchecked"> Có sử dụng bảo hiểm y tế<br><br>--}}
                            <div class="row"  >
                                <div class="col-sm-6"><video autoplay='true' id='videoElement'> </video><br></div>


                                <div class="col-sm-6" id="doublecheckinfo">
                                    <div class="row">
                                        <div class="col-sm-4" >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4" >
                                            <label name="so_bhyt"   >Giới tính : </label>
                                        </div>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4" >
                                            <label name="so_bhyt" >Quê Quán</label>
                                        </div>
                                        <div class="col-sm-4">
                                            <input id="so_cmt" minlength="10" class="required"  val="">
                                        </div>
                                    ...
                                    <input type="checkbox" id="checkbox_muasokham" checked="unchecked"> có mua sổ khám bệnh <br>
...
@section('customscript')
    ...
    <script>
        ...
        $("#checkbox_muasokham").prop("checked", false);
        setTimeout(function(){
