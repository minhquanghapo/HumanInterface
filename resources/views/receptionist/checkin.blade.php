...
@section('pagename')
    ...
    <form id="signup" action="somewhere" method="POST">
        <ul id="checkin-tabs">
            <li class="current active"><span>1.</span> Bảo hiểm y tế</li>
            <li><span>2.</span> Thông tin chi tiết</li>
        </ul>
        <div id="fieldsets">
            ...
            <fieldset class="current">
                ...
                <div class="row"  style=" visibility :hidden">
                    <div class="col-sm-6"><video autoplay='true' id='videoElement' style=" visibility :hidden"> </video><br></div>
            ...
            <fieldset class="next">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input id="ten_nb" minlength="10" class="required"  value="">
                    </div>
                </div>
